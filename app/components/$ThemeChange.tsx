export const ThemeChange = () => (
  <>
    <button id='themeChange' class='btn btn-square btn-ghost swap' type='button'>
      <svg
        class='sun swap-on fill-current w-5 h-5'
      ...
      <svg
        class='moon swap-off fill-current w-5 h-5'
        xmlns='http://www.w3.org/2000/svg'
        viewBox='0 0 24 24'
        title='Moon'
        role='img'
    ...
    {/* <style>
 :global(html[data-theme='winter']) .sun {
  opacity: 1;
 }
 :global(html[data-theme='winter']) .moon {
  opacity: 0;
 }
 :global(html[data-theme='night']) .sun {
  opacity: 0;
 }
 :global(html[data-theme='night']) .moon {
  opacity: 1;
 }
</style>
...
const handleToggleClick = () => {
  ...
  if (theme === 'winter') {
    ...
    element.setAttribute('data-theme', 'winter')
